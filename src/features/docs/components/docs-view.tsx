    ...
    <DocsPageTransition>
      <div className="space-y-16 pb-24">
        ...
        <div className="space-y-16">
          ...
          {/* login */}
          <section id="login" className="space-y-4 pt-4">
            <h3 className="text-2xl font-bold text-white font-mono flex items-center gap-3">
              <span className="text-zinc-500">$</span> pvc login
            </h3>
            <p className="text-zinc-400 text-lg">
              Authenticate with the remote server. Supports SSH-based login.
            </p>
            <CodeBlock code="pvc login --ssh" title="Login using SSH" />
          </section>

          {/* push */}
          <section id="push" className="space-y-4 pt-4">
            <h3 className="text-2xl font-bold text-white font-mono flex items-center gap-3">
              <span className="text-zinc-500">$</span> pvc push
            </h3>
            <p className="text-zinc-400 text-lg">
              Manually push reports to the configured remote.
            </p>
            <CodeBlock code="pvc push" />
          </section>
          ...
          <section id="watch" className="space-y-4 pt-4">
            ...
            <CodeBlock code="pvc watch --detach" title="Start in background" />
            <CodeBlock code="pvc watch stop" title="Stop watcher" />
          </section>
