...
import { Send, RefreshCw, Copy, Check, AlertCircle, Lock } from 'lucide-react';
...
interface TelegramSettingsProps {
  ...
  isPremiumFeatureAvailable?: boolean;
}
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center space-y-4">
              ...
              <div className="space-y-2 max-w-sm">
                ...
                <p className="text-sm text-zinc-400">
                  Telegram notifications are available only for Premium
                  workspaces. Please ask the workspace owner to upgrade their
                  plan.
                </p>
              </div>
              <Button
